...
model = mebm.MoistEnergyBalanceModel(
    N_pts = 2**9+1, 
    max_iters = 1e3, 
    tol = 1e-4, 
...
# %%
# Check content of `simulation.npz`
simulation_data = np.load("simulation_data.npz")
ctrl = np.load("ctrl.npz")
