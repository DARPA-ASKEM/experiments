...
# 
# The MIRA MMT and Petri Net representations do not store the original mathematical model correctly.
# 
# ODE system:
# dS/dt = - alpha * S * I - beta * S * D - gamma * S * A - delta S * R
# dI/dt =   alpha * S * I + beta * S * D + gamma * S * A + delta S * R - epsilon * I - zeta * I - lambda * I
# dD/dt =   epsilon * I - eta * D - rho * D
# dA/dt =   zeta * I - theta * A - mu * A - kappa * A
# dR/dt =   eta * D + theta * A - nu * R - xi * R
# dT/dt =   mu * A + nu * R - sigma * T - tau * T
# dH/dt =   lambda * I + rho * D + kappa * A + xi * R + sigma * T
# dE/dt =   tau * T
#
# MMT relations:
# 1.  S -> alpha (I) -> I
